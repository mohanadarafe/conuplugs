...
class ODCU_library{
	...
	function getID(){
		...
		$url = $this->baseURL."catalog/filter/SOEN/344/*";			
	        ...
	        <div class="container">
                ...
                <div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
							...
							<a href="http://www.ratemyprofessors.com/ShowRatings.jsp?tid=1649890" target=__blank>Nora Houari</a> <!--Name of Teacher-->
				...
				<div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
							...
							<a href="https://drive.google.com/drive/folders/0B4vsswP0Cf0HbGZLVVUtOEUyaUE" 
								target="__blank">
								<p>Assignments</p>
                            </a>           
						</div>
