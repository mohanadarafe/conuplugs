...
class ODCU_library{
	...
	function getID(){
		...
		$url = $this->baseURL."catalog/filter/SOEN/345/*";			
	        ...
	        <div class="container">
                ...
                <div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
							...
							<a href="http://www.ratemyprofessors.com/ShowRatings.jsp?tid=1790325" target=__blank>Peter Rigby</a> <!--Name of Teacher-->
                            ...
                            <a href="http://www.ratemyprofessors.com/ShowRatings.jsp?tid=1615587" target=__blank>Daniel Sinnig</a> <!--Name of Teacher-->
							<span class="fa fa-star checked"></span> <!--fa-star means full star-->
							<span class="fa fa-star checked"></span> <!--fa-star-half means half star-->
							<span class="fa fa-star checked"></span> <!--fa-star-o means empty star-->
							<span class="fa fa-star checked"></span>
				...
				<div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
                            ...
                            <a href="https://drive.google.com/drive/folders/0B4vsswP0Cf0HSHUxMXhYRVpMVUE" 
								target="__blank">
								<p>Winter 2014 Quiz I</p>
                            </a>     
							<a href="https://exambank.kcamel.com/exams/SOEN%20345/hw/Class%20Notes.pdf" 
								target="__blank">
								<p>Class Notes</p>
                            </a>           
						</div>
