...
class ODCU_library{
	...
	function getID(){
		...
		$url = $this->baseURL."catalog/filter/ENGR/202/*";			
	        ...
	        <div class="container">
                ...
                <div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
							...
							<a href="http://www.ratemyprofessors.com/ShowRatings.jsp?tid=468990" target=__blank>John Hadjinicolaou</a> <!--Name of Teacher-->
				...
				<div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
							...
							<a href="https://drive.google.com/drive/folders/0B4vsswP0Cf0HMFZlYTlhOFRLT2c" 
								target="__blank">
								<p>Fall 2012 Midterm</p>
                            </a>
                            <a href="https://drive.google.com/drive/folders/0B4vsswP0Cf0HMFZlYTlhOFRLT2c" 
								target="__blank">
								<p>Midterm Question Bank</p>
                            </a>
                            <a href="https://drive.google.com/drive/folders/0B4vsswP0Cf0HMFZlYTlhOFRLT2c" 
								target="__blank">
								<p>Final 2012</p>
