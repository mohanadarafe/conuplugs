...
class ODCU_library{
	...
	function getID(){
		...
		$url = $this->baseURL."catalog/filter/SOEN/390/*";			
	        ...
	        <div class="container">
                ...
                <div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
							...
							<a href="http://www.ratemyprofessors.com/ShowRatings.jsp?tid=2099740" target=__blank>Weiyi Ian Shang</a> <!--Name of Teacher-->
