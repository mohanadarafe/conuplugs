...
class ODCU_library{
	...
	function getID(){
		...
		$url = $this->baseURL."catalog/filter/SOEN/341/*";			
	        ...
	        <div class="container">
                ...
                <div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
							...
							<a href="http://www.ratemyprofessors.com/ShowRatings.jsp?tid=511872" target=__blank>Constantinos Constantinides</a> <!--Name of Teacher-->
                            ...
                            <br/><br/>
                            <a href="http://www.ratemyprofessors.com/ShowRatings.jsp?tid=1919483" target=__blank>Emad Shihab</a> <!--Name of Teacher-->
							<span class="fa fa-star checked"></span> <!--fa-star means full star-->
							<span class="fa fa-star checked"></span> <!--fa-star-half means half star-->
							<span class="fa fa-star checked"></span> <!--fa-star-o means empty star-->
							...
							<span class="fa fa-star-o checked"></span>
                            <br/><br/>
                            <a href="http://www.ratemyprofessors.com/ShowRatings.jsp?tid=448786php" target=__blank>Terrill Fancott</a> <!--Name of Teacher-->
							<span class="fa fa-star checked"></span> <!--fa-star means full star-->
							<span class="fa fa-star checked"></span> <!--fa-star-half means half star-->
							<span class="fa fa-star checked"></span> <!--fa-star-o means empty star-->
							<span class="fa fa-star-half checked"></span>
							<span class="fa fa-star-o checked"></span>
                            <br/><br/>
                            <a href="http://www.ratemyprofessors.com/ShowRatings.jsp?tid=2332795" target=__blank>Tse-Hsun Peter Chen</a> <!--Name of Teacher-->
							<span class="fa fa-star checked"></span> <!--fa-star means full star-->
							<span class="fa fa-star checked"></span> <!--fa-star-half means half star-->
							<span class="fa fa-star checked"></span> <!--fa-star-o means empty star-->
							<span class="fa fa-star-half checked"></span>
				...
				<div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
                            ...
                            <a href="https://exambank.kcamel.com/exams/SOEN%20341/midterms/Sample.pdf" 
								target="__blank">
								<p>Sample Midterm</p>
                            </a>
						</div>
