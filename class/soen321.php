...
class ODCU_library{
	...
	function getID(){
		...
		$url = $this->baseURL."catalog/filter/SOEN/321/*";			
	        ...
	        <div class="container">
                ...
                <div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
							...
							<a href="http://www.ratemyprofessors.com/ShowRatings.jsp?tid=547621" target=__blank>Amr Youssef</a> <!--Name of Teacher-->
                            ...
                            <br/><br/>
                            <a href="http://www.ratemyprofessors.com/ShowRatings.jsp?tid=1746773" target=__blank>Mohammad Mannan</a> <!--Name of Teacher-->
							<span class="fa fa-star checked"></span> <!--fa-star means full star-->
							<span class="fa fa-star checked"></span> <!--fa-star-half means half star-->
							<span class="fa fa-star checked"></span> <!--fa-star-o means empty star-->
							<span class="fa fa-star-o checked"></span>
				...
				<div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
							...
							<a href="https://slideplayer.com/slide/4795052/" 
								target="__blank">
								<p>Midtern Review</p>
                            </a>
						</div>
