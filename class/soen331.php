...
class ODCU_library{
	...
	function getID(){
		...
		$url = $this->baseURL."catalog/filter/SOEN/331/*";			
	        ...
	        <div class="container">
				...
				<div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
							...
							<a href="https://exambank.kcamel.com/exams/SOEN%20331/midterms/2017%20Winter%20Sample%20A%20Solutions.pdf" 
								target="__blank">
								<p>Winter 2017 Midterm</p>
                            </a>
                            <a href="https://drive.google.com/drive/folders/0B4vsswP0Cf0HVTdWQjFucEZQRTQ" 
								target="__blank">
								<p>Sample Midterm</p>
                            </a>
						</div>
