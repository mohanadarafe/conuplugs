...
class ODCU_library{
	...
	function getID(){
		...
		$url = $this->baseURL."catalog/filter/COMP/352/*";			
	        ...
	        <div class="container">
				...
				<div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
							...
							<a href="https://exambank.kcamel.com/exams/COMP%20352/midterms/2016%20Summer.pdf" 
								target="__blank">
								<p>Summer 2016 Midterm</p>
                            </a>        
                            <a href="https://www.dropbox.com/s/60uiia4q9j8s1m8/example-midterm.pdf?dl=0" 
								target="__blank">
								<p>Sample Midterm</p>
                            </a>  
						</div>
