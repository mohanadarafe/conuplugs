...
class ODCU_library{
	...
	function getID(){
		...
		$url = $this->baseURL."catalog/filter/SOEN/385/*";			
	        ...
	        <div class="container">
                ...
                <div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
							...
							<a href="http://www.ratemyprofessors.com/ShowRatings.jsp?tid=2278278" target=__blank>Ahmad Hemami</a> <!--Name of Teacher-->
				...
				<div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
                            ...
                            <a href="https://drive.google.com/drive/folders/0B4vsswP0Cf0HV1A2ZElOOWNFSDg" 
								target="__blank">
								<p>Assignments</p>
                            </a>
						</div>
