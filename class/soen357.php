...
class ODCU_library{
	...
	function getID(){
		...
		$url = $this->baseURL."catalog/filter/SOEN/357/*";			
	        ...
	        <div class="container">
                ...
                <div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
							...
							<a href="http://www.ratemyprofessors.com/ShowRatings.jsp?tid=180361" target=__blank>Dr. Rajagopalan Jayakumar</a> <!--Name of Teacher-->
				...
				<div class="row">
                        <div class="col-sm-12 features-box wow fadeInLeft">
							...
							<a href="https://drive.google.com/file/d/1ff9lfpY6Zf9MlbKn6u7NqVRvCVQDBpuC/view" 
								target="__blank">
								<p>[ASSIGNMENT] Assignment 1</p>
							</a>
							<a href="https://drive.google.com/file/d/1prIRVAcvLCxgBbiQ38lytqFEuadJDArh/view" 
								target="__blank">
								<p>[ASSIGNMENT] Assignment 2</p>
							</a>
							<a href="https://drive.google.com/file/d/1Z-WSbD9c_EhQxhCgx5MggAsF2-cJzP_N/view?usp=drive_open" 
								target="__blank">
								<p>[ASSIGNMENT] Assignment 3</p>
							</a>
							<a href="https://docs.google.com/document/d/1HU0sGeY_HNOFj_ufsV0x5OgfLAYDjDH6v34VgSCP930/edit" 
								target="__blank">
								<p>[MIDTERM] Quiz 1</p>
							</a>
							<a href="https://docs.google.com/document/d/1p3g4vuoTc1f6V46iZnD0vfnaqt-Si17PH596301xs5Q/edit?usp=drive_web&ouid=108367127916859569307" 
								target="__blank">
								<p>[MIDTERM] Quiz 2</p>
							</a>
						</div>
